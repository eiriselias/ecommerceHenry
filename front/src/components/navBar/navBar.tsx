...
const NavBar:React.FC = () => {
  return (
    <div className="flex z-10 p-4 pl-8 justify-between ml-16 mt-2 bg-gradient-to-l from-blue-500 via-purple-100 to-green-500 rounded-l-full sticky shadow-ps">
